...
// --- MINECRAFT DATA (史诗终章版 - 50关全手写) ---
const MC_EPISODES = [
  // Arc 1: Siren Head & House Head (1-5)
  { id: 1, title: "Strange Noise", titleCN: "奇怪的声音", emoji: "🌲", scenes: [ { text: "JJ and Mikey were chopping trees.", translation: "JJ和Mikey正在砍树。", imageParams: "bg-green-700", character: "🪓" }, { text: "The forest was dark and foggy.", translation: "森林又黑又雾。", imageParams: "bg-gray-800", character: "🌫️" }, { text: "Suddenly, a siren sounded. Wee-woo!", translation: "突然，警报响了。呜——呜——！", imageParams: "bg-red-900", character: "📢" }, { text: "Mikey dropped his axe.", translation: "Mikey吓掉了斧头。", imageParams: "bg-stone-600", character: "😱" }, { text: "What is that noise? asked JJ.", translation: "那是什么声音？JJ问。", imageParams: "bg-blue-800", character: "❓" }, { text: "Run! It is coming closer!", translation: "快跑！它逼近了！", imageParams: "bg-green-900", character: "🏃" } ], vocab: [{ word: "Tree", cn: "树", emoji: "🌲" }, { word: "Noise", cn: "噪音", emoji: "🔊" }, { word: "Run", cn: "跑", emoji: "🏃" }, { word: "Dark", cn: "黑", emoji: "🌑" }], quiz: { question: "What did they hear?", options: ["A Siren 🚨", "A Bird 🐦"], answer: 0 } },
  { id: 2, title: "Siren Head", titleCN: "警笛头", emoji: "🚨", scenes: [ { text: "A giant shadow stood up.", translation: "一个巨大的黑影站了起来。", imageParams: "bg-gray-900", character: "👤" }, { text: "It was Siren Head!", translation: "是警笛头！", imageParams: "bg-red-800", character: "🚨" }, { text: "He has two sirens for a head.", translation: "他长着两个警报器头。", imageParams: "bg-stone-800", character: "🔊" }, { text: "He is taller than the trees.", translation: "他比树还要高。", imageParams: "bg-green-800", character: "🦒" }, { text: "Hide in that house! yelled JJ.", translation: "躲进那个房子！JJ喊道。", imageParams: "bg-orange-200", character: "🏠" }, { text: "They ran to a wooden cabin.", translation: "他们跑向一个小木屋。", imageParams: "bg-brown-600", character: "🚪" } ], vocab: [{ word: "Shadow", cn: "影子", emoji: "👤" }, { word: "Tall", cn: "高", emoji: "🦒" }, { word: "Hide", cn: "躲藏", emoji: "🙈" }, { word: "House", cn: "房子", emoji: "🏠" }], quiz: { question: "Is Siren Head short?", options: ["No", "Yes"], answer: 0 } },
  { id: 3, title: "House Head", titleCN: "房子头", emoji: "🏠", scenes: [ { text: "They ran inside the house.", translation: "他们跑进了房子。", imageParams: "bg-orange-100", character: "📥" }, { text: "Safe at last! said Mikey.", translation: "终于安全了！Mikey说。", imageParams: "bg-blue-100", character: "😌" }, { text: "Suddenly, the floor moved.", translation: "突然，地板动了。", imageParams: "bg-brown-400 animate-bounce", character: "🏚️" }, { text: "The house stood up on legs!", translation: "房子长腿站起来了！", imageParams: "bg-stone-700", character: "🦵" }, { text: "It is a House Monster!", translation: "这是个房子怪！", imageParams: "bg-red-600", character: "👹" }, { text: "Jump out the window!", translation: "跳窗逃跑！", imageParams: "bg-sky-300", character: "🪟" } ], vocab: [{ word: "Safe", cn: "安全", emoji: "🛡️" }, { word: "Floor", cn: "地板", emoji: "🟫" }, { word: "Legs", cn: "腿", emoji: "🦵" }, { word: "Window", cn: "窗户", emoji: "🪟" }], quiz: { question: "Did the house move?", options: ["Yes", "No"], answer: 0 } },
  { id: 4, title: "Monster Battle", titleCN: "怪物大战", emoji: "⚔️", scenes: [ { text: "Siren Head saw the House Monster.", translation: "警笛头看见了房子怪。", imageParams: "bg-gray-700", character: "👀" }, { text: "They started to fight.", translation: "他们开始打架。", imageParams: "bg-red-500", character: "⚔️" }, { text: "Boom! Trees fell down.", translation: "轰！树倒了。", imageParams: "bg-green-800", character: "🪵" }, { text: "Smash! Blocks flew everywhere.", translation: "砰！方块乱飞。", imageParams: "bg-orange-500", character: "🧱" }, { text: "Now is our chance to escape.", translation: "现在是我们逃跑的机会。", imageParams: "bg-blue-600", character: "✨" }, { text: "Let's make a trap!", translation: "我们做个陷阱吧！", imageParams: "bg-stone-600", character: "🕳️" } ], vocab: [{ word: "Fight", cn: "打架", emoji: "🥊" }, { word: "Fall", cn: "倒下", emoji: "⬇️" }, { word: "Trap", cn: "陷阱", emoji: "🕸️" }, { word: "Chance", cn: "机会", emoji: "✨" }], quiz: { question: "Are they fighting?", options: ["Yes", "No"], answer: 0 } },
  { id: 5, title: "TNT Trap", titleCN: "TNT陷阱", emoji: "🧨", scenes: [ { text: "Mikey crafted lots of TNT.", translation: "Mikey合成了一堆TNT。", imageParams: "bg-red-600", character: "🧨" }, { text: "JJ dug a big hole.", translation: "JJ挖了一个大坑。", imageParams: "bg-stone-800", character: "🕳️" }, { text: "They lured the monsters.", translation: "他们引诱怪物过来。", imageParams: "bg-yellow-400", character: "👋" }, { text: "The monsters fell in.", translation: "怪物们掉进去了。", imageParams: "bg-black", character: "⬇️" }, { text: "Mikey lit the fuse.", translation: "Mikey点燃了引线。", imageParams: "bg-orange-500", character: "🔥" }, { text: "Kaboom! We are safe.", translation: "轰隆！我们要全了。", imageParams: "bg-white", character: "💥" } ], vocab: [{ word: "Craft", cn: "合成", emoji: "🔨" }, { word: "Hole", cn: "洞", emoji: "🕳️" }, { word: "Safe", cn: "安全", emoji: "✅" }, { word: "Fuse", cn: "引线", emoji: "〰️" }], quiz: { question: "What exploded?", options: ["TNT", "Cake"], answer: 0 } },

  // Arc 2: Nether & Fortress (6-15)
  { id: 6, title: "Nether Portal", titleCN: "地狱门", emoji: "🔥", scenes: [{text:"We need obsidian.", translation:"我们需要黑曜石。", imageParams:"bg-black", character:"⬛"}, {text:"Pour water on lava.", translation:"把水浇在岩浆上。", imageParams:"bg-orange-600", character:"🌊🔥"}, {text:"JJ built a rectangle frame.", translation:"JJ建了个长方形框。", imageParams:"bg-purple-900", character:"🚪"}, {text:"Mikey used flint and steel.", translation:"Mikey用了打火石。", imageParams:"bg-gray-400", character:"🔥"}, {text:"The portal turned purple.", translation:"传送门变紫了。", imageParams:"bg-purple-600", character:"✨"}, {text:"Jump in!", translation:"跳进去！", imageParams:"bg-purple-800", character:"🏃"}], vocab:[{word:"Build", cn:"建造", emoji:"🏗️"}, {word:"Fire", cn:"火", emoji:"🔥"}, {word:"Jump", cn:"跳", emoji:"🆙"}, {word:"Purple", cn:"紫色", emoji:"🟣"}], quiz:{question:"What color is the portal?", options:["Purple", "Green"], answer:0}},
  { id: 7, title: "The Nether", titleCN: "下界", emoji: "🌋", scenes: [{text:"It is very hot here.", translation:"这里非常热。", imageParams:"bg-red-900", character:"🌡️"}, {text:"Lava falls from the roof.", translation:"岩浆从顶上流下来。", imageParams:"bg-orange-500", character:"🌋"}, {text:"Ghostly sounds are scary.", translation:"鬼叫声很吓人。", imageParams:"bg-gray-800", character:"👻"}, {text:"Watch out for fire!", translation:"小心火！", imageParams:"bg-red-600", character:"🔥"}, {text:"Mikey saw a castle.", translation:"Mikey看到了一座城堡。", imageParams:"bg-black", character:"🏰"}, {text:"It is a Nether Fortress.", translation:"那是下界要塞。", imageParams:"bg-red-900", character:"🧱"}], vocab:[{word:"Hot", cn:"热", emoji:"🥵"}, {word:"Lava", cn:"岩浆", emoji:"🌋"}, {word:"Scary", cn:"吓人", emoji:"😱"}, {word:"Castle", cn:"城堡", emoji:"🏰"}], quiz:{question:"Is it cold in the Nether?", options:["No", "Yes"], answer:0}},
  { id: 8, title: "Wither Skeleton", titleCN: "凋零骷髅", emoji: "💀", scenes: [{text:"Tall black skeletons appeared.", translation:"高大的黑骷髅出现了。", imageParams:"bg-gray-900", character:"💀"}, {text:"They held stone swords.", translation:"他们拿着石剑。", imageParams:"bg-gray-600", character:"🗡️"}, {text:"They run very fast.", translation:"他们跑得很快。", imageParams:"bg-black", character:"🏃‍♂️"}, {text:"JJ used his shield.", translation:"JJ用了盾牌。", imageParams:"bg-blue-700", character:"🛡️"}, {text:"Mikey used a bow.", translation:"Mikey用了弓箭。", imageParams:"bg-brown-500", character:"🏹"}, {text:"They dropped a black skull.", translation:"他们掉了一个黑头颅。", imageParams:"bg-gray-800", character:"💀"}], vocab:[{word:"Skeleton", cn:"骷髅", emoji:"💀"}, {word:"Sword", cn:"剑", emoji:"🗡️"}, {word:"Shield", cn:"盾牌", emoji:"🛡️"}, {word:"Fast", cn:"快", emoji:"⚡"}], quiz:{question:"What dropped?", options:["A Skull", "A Flower"], answer:0}},
  { id: 9, title: "Blaze Spawner", titleCN: "烈焰人刷怪笼", emoji: "☄️", scenes: [{text:"They found a spawner.", translation:"他们发现了刷怪笼。", imageParams:"bg-black", character:"🕸️"}, {text:"Yellow monsters flew out.", translation:"黄色怪物飞了出来。", imageParams:"bg-yellow-600", character:"👿"}, {text:"They are Blazes!", translation:"是烈焰人！", imageParams:"bg-orange-500", character:"🔥"}, {text:"They shoot fireballs.", translation:"他们射出火球。", imageParams:"bg-red-500", character:"☄️"}, {text:"JJ threw snowballs.", translation:"JJ扔了雪球。", imageParams:"bg-white", character:"❄️"}, {text:"They got Blaze Rods.", translation:"他们得到了烈焰棒。", imageParams:"bg-yellow-400", character:"🥢"}], vocab:[{word:"Fly", cn:"飞", emoji:"🕊️"}, {word:"Shoot", cn:"射击", emoji:"🔫"}, {word:"Snow", cn:"雪", emoji:"❄️"}, {word:"Rod", cn:"棒", emoji:"🥢"}], quiz:{question:"What do Blazes shoot?", options:["Fireballs", "Water"], answer:0}},
  { id: 10, title: "Piglin Barter", titleCN: "猪灵交易", emoji: "🐷", scenes: [{text:"Piglins live here too.", translation:"猪灵也住在这里。", imageParams:"bg-red-300", character:"🐷"}, {text:"They love gold.", translation:"他们喜欢金子。", imageParams:"bg-yellow-400", character:"💰"}, {text:"Mikey wore gold boots.", translation:"Mikey穿了金靴子。", imageParams:"bg-yellow-500", character:"👢"}, {text:"He gave them a gold ingot.", translation:"他给了一块金锭。", imageParams:"bg-yellow-300", character:"🧈"}, {text:"The Piglin gave Ender Pearls.", translation:"猪灵给了末影珍珠。", imageParams:"bg-green-800", character:"🟢"}, {text:"Thank you piggy!", translation:"谢谢小猪！", imageParams:"bg-pink-200", character:"🙏"}], vocab:[{word:"Gold", cn:"金子", emoji:"🥇"}, {word:"Love", cn:"爱", emoji:"❤️"}, {word:"Give", cn:"给", emoji:"🎁"}, {word:"Pearl", cn:"珍珠", emoji:"🔮"}], quiz:{question:"What do Piglins love?", options:["Gold", "Iron"], answer:0}},
  { id: 11, title: "Soul Sand Valley", titleCN: "灵魂沙峡谷", emoji: "🦴", scenes: [{text:"The ground was blue.", translation:"地面是蓝色的。", imageParams:"bg-blue-900", character:"🟦"}, {text:"It slowed them down.", translation:"它让他们变慢了。", imageParams:"bg-gray-500", character:"🐢"}, {text:"Giant fossils lay everywhere.", translation:"巨大的化石到处都是。", imageParams:"bg-white", character:"🦴"}, {text:"Ghasts flew in the sky.", translation:"恶魂在天上飞。", imageParams:"bg-gray-200", character:"👻"}, {text:"They shoot exploding balls.", translation:"它们射出爆炸球。", imageParams:"bg-red-500", character:"💥"}, {text:"Hit it back!", translation:"打回去！", imageParams:"bg-green-400", character:"🎾"}], vocab:[{word:"Slow", cn:"慢", emoji:"🐢"}, {word:"Sky", cn:"天空", emoji:"☁️"}, {word:"Explode", cn:"爆炸", emoji:"💣"}, {word:"Hit", cn:"打", emoji:"🏏"}], quiz:{question:"What flies in the sky?", options:["Ghast", "Pig"], answer:0}},
  { id: 12, title: "Magma Cube", titleCN: "岩浆怪", emoji: "🟥", scenes: [{text:"Something jumped at them.", translation:"有个东西跳向他们。", imageParams:"bg-red-600", character:"🆙"}, {text:"It was a Magma Cube.", translation:"是个岩浆怪。", imageParams:"bg-orange-800", character:"🟥"}, {text:"It split into small ones.", translation:"它分裂成了小的。", imageParams:"bg-orange-500", character:"🎲"}, {text:"They are very bouncy.", translation:"它们很Q弹。", imageParams:"bg-yellow-500", character:"🏀"}, {text:"JJ pushed them into lava.", translation:"JJ把它们推下岩浆。", imageParams:"bg-red-800", character:"👋"}, {text:"We need to cross the lake.", translation:"我们需要过湖。", imageParams:"bg-orange-400", character:"🌊"}], vocab:[{word:"Jump", cn:"跳", emoji:"🦘"}, {word:"Small", cn:"小", emoji:"🤏"}, {word:"Push", cn:"推", emoji:"👐"}, {word:"Lake", cn:"湖", emoji:"🏞️"}], quiz:{question:"Do they bounce?", options:["Yes", "No"], answer:0}},
  { id: 13, title: "Strider Ride", titleCN: "骑乘炽足兽", emoji: "👾", scenes: [{text:"Mikey found a Strider.", translation:"Mikey发现了一只炽足兽。", imageParams:"bg-red-400", character:"👾"}, {text:"It walks on lava.", translation:"它在岩浆上走。", imageParams:"bg-orange-600", character:"👣"}, {text:"Put a saddle on it.", translation:"给它放个鞍。", imageParams:"bg-brown-500", character:"💺"}, {text:"Use a fungus on a stick.", translation:"用诡异菌钓竿。", imageParams:"bg-green-400", character:"🎣"}, {text:"It runs very fast now!", translation:"它现在跑得很快！", imageParams:"bg-red-500", character:"🏎️"}, {text:"They reached the other side.", translation:"他们到了对岸。", imageParams:"bg-stone-600", character:"🏁"}], vocab:[{word:"Walk", cn:"走", emoji:"🚶"}, {word:"Stick", cn:"棍子", emoji:"🥖"}, {word:"Fast", cn:"快", emoji:"⚡"}, {word:"Side", cn:"边", emoji:"↔️"}], quiz:{question:"What does it walk on?", options:["Lava", "Water"], answer:0}},
  { id: 14, title: "Warped Forest", titleCN: "诡异森林", emoji: "🌲", scenes: [{text:"The forest was blue.", translation:"森林是蓝色的。", imageParams:"bg-cyan-800", character:"🌲"}, {text:"Endermen were here.", translation:"末影人在这。", imageParams:"bg-black", character:"👁️"}, {text:"Don't look at their eyes!", translation:"别看他们的眼睛！", imageParams:"bg-purple-500", character:"🚫"}, {text:"They collected Warped Wood.", translation:"他们收集了诡异木。", imageParams:"bg-cyan-600", character:"🪵"}, {text:"It does not burn.", translation:"它不会烧着。", imageParams:"bg-blue-400", character:"🛡️"}, {text:"Perfect for a base.", translation:"做基地很完美。", imageParams:"bg-green-500", character:"🏠"}], vocab:[{word:"Blue", cn:"蓝色", emoji:"🔵"}, {word:"Eye", cn:"眼睛", emoji:"👀"}, {word:"Wood", cn:"木头", emoji:"🪵"}, {word:"Burn", cn:"燃烧", emoji:"🔥"}], quiz:{question:"What color is the forest?", options:["Blue", "Red"], answer:0}},
  { id: 15, title: "Return Home", titleCN: "重返主世界", emoji: "🏡", scenes: [{text:"They had enough loot.", translation:"他们有足够的战利品了。", imageParams:"bg-yellow-200", character:"🎒"}, {text:"Find the portal again.", translation:"再找到传送门。", imageParams:"bg-purple-800", character:"🔍"}, {text:"JJ felt dizzy.", translation:"JJ感到头晕。", imageParams:"bg-gray-400", character:"😵‍💫"}, {text:"They stepped through.", translation:"他们跨了过去。", imageParams:"bg-purple-600", character:"🦶"}, {text:"Fresh air at last!", translation:"终于有新鲜空气了！", imageParams:"bg-sky-300", character:"🌬️"}, {text:"Time to find The End.", translation:"该去找末地了。", imageParams:"bg-black", character:"🌌"}], vocab:[{word:"Home", cn:"家", emoji:"🏡"}, {word:"Find", cn:"找", emoji:"🔎"}, {word:"Air", cn:"空气", emoji:"💨"}, {word:"Time", cn:"时间", emoji:"⏰"}], quiz:{question:"Where did they go?", options:["Home", "Nether"], answer:0}},

  // Arc 3: The End (16-25)
  { id: 16, title: "Eye of Ender", titleCN: "末影之眼", emoji: "👁️", scenes: [{text:"They need Eyes of Ender.", translation:"他们需要末影之眼。", imageParams:"bg-green-600", character:"👁️"}, {text:"Combine Blaze Powder.", translation:"混合烈焰粉。", imageParams:"bg-orange-400", character:"🔥"}, {text:"And Ender Pearls.", translation:"和末影珍珠。", imageParams:"bg-green-800", character:"🟢"}, {text:"The eye floats in the air.", translation:"眼睛漂浮在空中。", imageParams:"bg-sky-200", character:"🎈"}, {text:"Follow it!", translation:"跟着它！", imageParams:"bg-blue-500", character:"🏃"}, {text:"It leads to the Stronghold.", translation:"它通向要塞。", imageParams:"bg-gray-700", character:"🏰"}], vocab:[{word:"Need", cn:"需要", emoji:"🤲"}, {word:"Float", cn:"漂浮", emoji:"☁️"}, {word:"Follow", cn:"跟随", emoji:"👣"}, {word:"Lead", cn:"带领", emoji:"👉"}], quiz:{question:"What leads the way?", options:["Eye", "Compass"], answer:0}},
  { id: 17, title: "Digging Down", titleCN: "向下挖掘", emoji: "⛏️", scenes: [{text:"The eye went into the ground.", translation:"眼睛钻进了地里。", imageParams:"bg-green-500", character:"⬇️"}, {text:"They started digging.", translation:"他们开始挖。", imageParams:"bg-brown-600", character:"⛏️"}, {text:"It was deep and dark.", translation:"又深又黑。", imageParams:"bg-black", character:"🌑"}, {text:"They hit stone bricks.", translation:"他们挖到了石砖。", imageParams:"bg-gray-400", character:"🧱"}, {text:"We found it!", translation:"我们找到了！", imageParams:"bg-yellow-200", character:"🎉"}, {text:"Enter the Stronghold.", translation:"进入要塞。", imageParams:"bg-gray-800", character:"🚪"}], vocab:[{word:"Dig", cn:"挖", emoji:"⛏️"}, {word:"Ground", cn:"地面", emoji:"🌱"}, {word:"Deep", cn:"深", emoji:"🕳️"}, {word:"Brick", cn:"砖", emoji:"🧱"}], quiz:{question:"What did they find?", options:["Bricks", "Sand"], answer:0}},
  { id: 18, title: "The Library", titleCN: "图书馆", emoji: "📚", scenes: [{text:"They explored the halls.", translation:"他们探索走廊。", imageParams:"bg-gray-600", character:"🚶"}, {text:"They found a library.", translation:"他们发现了图书馆。", imageParams:"bg-brown-700", character:"📚"}, {text:"Cobwebs were everywhere.", translation:"到处都是蜘蛛网。", imageParams:"bg-white", character:"🕸️"}, {text:"Mikey found a book.", translation:"Mikey找到一本书。", imageParams:"bg-blue-200", character:"📖"}, {text:"It had Mending enchant.", translation:"它是经验修补附魔。", imageParams:"bg-purple-300", character:"✨"}, {text:"This is very rare.", translation:"这非常稀有。", imageParams:"bg-gold-100", character:"💎"}], vocab:[{word:"Explore", cn:"探索", emoji:"🗺️"}, {word:"Book", cn:"书", emoji:"📘"}, {word:"Rare", cn:"稀有", emoji:"🌟"}, {word:"Web", cn:"网", emoji:"🕸️"}], quiz:{question:"What was in the library?", options:["Books", "Food"], answer:0}},
  { id: 19, title: "Silverfish", titleCN: "蠹虫", emoji: "🐛", scenes: [{text:"They heard a hissing sound.", translation:"他们听到嘶嘶声。", imageParams:"bg-gray-500", character:"👂"}, {text:"Small bugs came out of walls.", translation:"小虫子从墙里钻出来。", imageParams:"bg-gray-300", character:"🐛"}, {text:"Silverfish attack!", translation:"蠹虫攻击！", imageParams:"bg-red-500", character:"⚔️"}, {text:"They are small but fast.", translation:"它们虽小但很快。", imageParams:"bg-gray-400", character:"⚡"}, {text:"Don't break the blocks!", translation:"别打碎方块！", imageParams:"bg-orange-500", character:"🚫"}, {text:"Run to the portal room.", translation:"跑到传送门房间。", imageParams:"bg-blue-600", character:"🏃"}], vocab:[{word:"Hear", cn:"听", emoji:"👂"}, {word:"Small", cn:"小", emoji:"🤏"}, {word:"Fast", cn:"快", emoji:"🏎️"}, {word:"Wall", cn:"墙", emoji:"🧱"}], quiz:{question:"Are Silverfish big?", options:["No", "Yes"], answer:0}},
  { id: 20, title: "End Portal", titleCN: "末地传送门", emoji: "🌌", scenes: [{text:"They found the portal.", translation:"他们找到了传送门。", imageParams:"bg-green-900", character:"🚪"}, {text:"Lava was underneath.", translation:"下面是岩浆。", imageParams:"bg-orange-600", character:"🌋"}, {text:"Silverfish spawner is here.", translation:"蠹虫刷怪笼在这。", imageParams:"bg-gray-600", character:"🕸️"}, {text:"Break the spawner first.", translation:"先打碎刷怪笼。", imageParams:"bg-stone-500", character:"🔨"}, {text:"Place the 12 eyes.", translation:"放上12只眼睛。", imageParams:"bg-green-400", character:"👁️"}, {text:"The portal opened black.", translation:"传送门打开了，黑色的。", imageParams:"bg-black", character:"✨"}], vocab:[{word:"Under", cn:"下面", emoji:"👇"}, {word:"Break", cn:"打破", emoji:"🔨"}, {word:"Place", cn:"放置", emoji:"🖐️"}, {word:"Open", cn:"打开", emoji:"🔓"}], quiz:{question:"What is under the portal?", options:["Lava", "Water"], answer:0}},
  { id: 21, title: "The End", titleCN: "末路之地", emoji: "🌑", scenes: [{text:"They spawned on a platform.", translation:"他们出生在平台上。", imageParams:"bg-stone-100", character:"🟨"}, {text:"The sky was purple.", translation:"天空是紫色的。", imageParams:"bg-purple-900", character:"🌌"}, {text:"They bridged to the island.", translation:"他们搭桥去岛上。", imageParams:"bg-stone-400", character:"🌉"}, {text:"Endermen were everywhere.", translation:"到处都是末影人。", imageParams:"bg-black", character:"👀"}, {text:"Wear a pumpkin head.", translation:"戴上南瓜头。", imageParams:"bg-orange-500", character:"🎃"}, {text:"Now they won't attack.", translation:"现在他们不会攻击了。", imageParams:"bg-green-500", character:"🛡️"}], vocab:[{word:"Sky", cn:"天空", emoji:"☁️"}, {word:"Bridge", cn:"桥", emoji:"🌉"}, {word:"Head", cn:"头", emoji:"🙆"}, {word:"Wear", cn:"穿/戴", emoji:"👕"}], quiz:{question:"What protects you?", options:["Pumpkin", "Apple"], answer:0}},
  { id: 22, title: "Obsidian Pillars", titleCN: "黑曜石柱", emoji: "🗼", scenes: [{text:"Giant pillars stood tall.", translation:"巨大的柱子矗立着。", imageParams:"bg-black", character:"🗼"}, {text:"Crystals were on top.", translation:"顶端有水晶。", imageParams:"bg-pink-400", character:"💎"}, {text:"They heal the dragon.", translation:"它们给龙回血。", imageParams:"bg-green-400", character:"➕"}, {text:"JJ climbed up.", translation:"JJ爬了上去。", imageParams:"bg-blue-500", character:"🧗"}, {text:"Mikey shot from below.", translation:"Mikey在下面射击。", imageParams:"bg-brown-500", character:"🏹"}, {text:"Boom! Crystal destroyed.", translation:"轰！水晶毁了。", imageParams:"bg-orange-500", character:"💥"}], vocab:[{word:"Tall", cn:"高", emoji:"🏙️"}, {word:"Top", cn:"顶部", emoji:"🔝"}, {word:"Heal", cn:"治疗", emoji:"❤️"}, {word:"Climb", cn:"爬", emoji:"🧗"}], quiz:{question:"What heals the dragon?", options:["Crystal", "Stone"], answer:0}},
  { id: 23, title: "Dragon Fight", titleCN: "决战恶龙", emoji: "🐲", scenes: [{text:"The Ender Dragon swooped down.", translation:"末影龙俯冲下来。", imageParams:"bg-purple-800", character:"🐲"}, {text:"It has purple breath.", translation:"它喷出紫色的气。", imageParams:"bg-purple-400", character:"💨"}, {text:"It hurts a lot.", translation:"非常疼。", imageParams:"bg-red-600", character:"🤕"}, {text:"Use empty bottles.", translation:"用空瓶子。", imageParams:"bg-white", character:"🍾"}, {text:"Collect dragon breath.", translation:"收集龙息。", imageParams:"bg-pink-300", character:"🧪"}, {text:"Hit it when it lands.", translation:"它落地时打它。", imageParams:"bg-gray-700", character:"⚔️"}], vocab:[{word:"Down", cn:"向下", emoji:"⬇️"}, {word:"Breath", cn:"呼吸/气息", emoji:"🌬️"}, {word:"Hurt", cn:"疼", emoji:"😣"}, {word:"Empty", cn:"空的", emoji:"🈳"}], quiz:{question:"Can you collect breath?", options:["Yes", "No"], answer:0}},
  { id: 24, title: "Victory", titleCN: "胜利", emoji: "🏆", scenes: [{text:"The dragon has no health.", translation:"龙没血了。", imageParams:"bg-red-200", character:"💔"}, {text:"It flew into the air.", translation:"它飞向空中。", imageParams:"bg-purple-700", character:"🛫"}, {text:"It exploded into light.", translation:"它炸成了光。", imageParams:"bg-white", character:"✨"}, {text:"Lots of XP orbs fell.", translation:"好多经验球掉下来。", imageParams:"bg-green-300", character:"🟢"}, {text:"A portal home appeared.", translation:"回家传送门出现了。", imageParams:"bg-gray-900", character:"🕳️"}, {text:"We did it!", translation:"我们做到了！", imageParams:"bg-yellow-300", character:"🥳"}], vocab:[{word:"Health", cn:"生命值", emoji:"❤️"}, {word:"Air", cn:"空气", emoji:"💨"}, {word:"Light", cn:"光", emoji:"💡"}, {word:"Home", cn:"家", emoji:"🏡"}], quiz:{question:"What fell down?", options:["XP", "Rain"], answer:0}},
  { id: 25, title: "Dragon Egg", titleCN: "龙蛋", emoji: "🥚", scenes: [{text:"On top of the portal.", translation:"在传送门顶上。", imageParams:"bg-gray-800", character:"🔝"}, {text:"There was a black egg.", translation:"有一个黑蛋。", imageParams:"bg-black", character:"🥚"}, {text:"Don't hit it!", translation:"别打它！", imageParams:"bg-red-500", character:"🚫"}, {text:"It will teleport away.", translation:"它会瞬移走。", imageParams:"bg-purple-400", character:"🪄"}, {text:"Use a piston to push it.", translation:"用活塞推它。", imageParams:"bg-brown-400", character:"🗜️"}, {text:"We got the egg!", translation:"我们要到了蛋！", imageParams:"bg-gold-200", character:"🤲"}], vocab:[{word:"Egg", cn:"蛋", emoji:"🥚"}, {word:"Hit", cn:"打", emoji:"👊"}, {word:"Push", cn:"推", emoji:"🫸"}, {word:"Get", cn:"得到", emoji:"🎁"}], quiz:{question:"Can the egg move?", options:["Yes", "No"], answer:0}},

  // Arc 4: Wither Storm Rises (26-40)
  { id: 26, title: "New Threat", titleCN: "新威胁", emoji: "📰", scenes: [{text:"Back in the Overworld.", translation:"回到主世界。", imageParams:"bg-green-500", character:"🌍"}, {text:"A villager ran to them.", translation:"一个村民跑向他们。", imageParams:"bg-brown-300", character:"🏃‍♂️"}, {text:"He looked very scared.", translation:"他看起来很害怕。", imageParams:"bg-blue-200", character:"😨"}, {text:"A monster is eating blocks.", translation:"有个怪物在吃方块。", imageParams:"bg-black", character:"👾"}, {text:"It grows bigger and bigger.", translation:"它变得越来越大。", imageParams:"bg-red-400", character:"📈"}, {text:"We must investigate.", translation:"我们必须去调查。", imageParams:"bg-yellow-600", character:"🔍"}], vocab:[{word:"Back", cn:"回来", emoji:"🔙"}, {word:"Scared", cn:"害怕", emoji:"😱"}, {word:"Eat", cn:"吃", emoji:"🍽️"}, {word:"Big", cn:"大", emoji:"🐘"}], quiz:{question:"Is the monster small?", options:["No", "Yes"], answer:0}},
  { id: 27, title: "Command Block", titleCN: "命令方块", emoji: "🟧", scenes: [{text:"They found a crater.", translation:"他们发现了一个陨石坑。", imageParams:"bg-stone-600", character:"🕳️"}, {text:"In the center was a block.", translation:"中间有个方块。", imageParams:"bg-orange-500", character:"🟧"}, {text:"It was glowing orange.", translation:"它发着橙光。", imageParams:"bg-yellow-300", character:"✨"}, {text:"A Wither skull was on top.", translation:"一个凋零头在上面。", imageParams:"bg-black", character:"💀"}, {text:"Do not touch it!", translation:"别碰它！", imageParams:"bg-red-600", character:"✋"}, {text:"Too late. It woke up.", translation:"太晚了。它醒了。", imageParams:"bg-purple-800", character:"👀"}], vocab:[{word:"Center", cn:"中心", emoji:"🎯"}, {word:"Orange", cn:"橙色", emoji:"🟧"}, {word:"Touch", cn:"碰", emoji:"👆"}, {word:"Wake", cn:"醒", emoji:"⏰"}], quiz:{question:"What color was the block?", options:["Orange", "Blue"], answer:0}},
  { id: 28, title: "It Begins", titleCN: "开始了", emoji: "🌪️", scenes: [{text:"The Wither started spinning.", translation:"凋零开始旋转。", imageParams:"bg-gray-700", character:"😵‍💫"}, {text:"It sucked up blocks.", translation:"它吸起了方块。", imageParams:"bg-brown-500", character:"🧱"}, {text:"Trees flew into it.", translation:"树飞进去了。", imageParams:"bg-green-800", character:"🌲"}, {text:"It became a tornado.", translation:"它变成了龙卷风。", imageParams:"bg-black", character:"🌪️"}, {text:"Our swords do nothing.", translation:"我们的剑没用。", imageParams:"bg-gray-400", character:"⚔️"}, {text:"We need better weapons.", translation:"我们需要更好的武器。", imageParams:"bg-blue-600", character:"🛡️"}], vocab:[{word:"Spin", cn:"旋转", emoji:"🔄"}, {word:"Tree", cn:"树", emoji:"🌳"}, {word:"Nothing", cn:"没用/无", emoji:"❌"}, {word:"Need", cn:"需要", emoji:"🤲"}], quiz:{question:"Did swords work?", options:["No", "Yes"], answer:0}},
  { id: 29, title: "Redstone Lab", titleCN: "红石实验室", emoji: "🔴", scenes: [{text:"They went to a lab.", translation:"他们去了一个实验室。", imageParams:"bg-stone-800", character:"🧪"}, {text:"It was full of Redstone.", translation:"里面全是红石。", imageParams:"bg-red-600", character:"🔴"}, {text:"Ivor the builder was there.", translation:"建造者Ivor在那里。", imageParams:"bg-green-700", character:"👴"}, {text:"He knows about the beast.", translation:"他知道那个怪兽。", imageParams:"bg-blue-300", character:"🧠"}, {text:"You need a Formidibomb.", translation:"你需要恐怖炸弹。", imageParams:"bg-black", character:"💣"}, {text:"It is a super TNT.", translation:"它是超级TNT。", imageParams:"bg-red-500", character:"🧨"}], vocab:[{word:"Lab", cn:"实验室", emoji:"🔬"}, {word:"Full", cn:"满", emoji:"🌕"}, {word:"Know", cn:"知道", emoji:"💡"}, {word:"Super", cn:"超级", emoji:"🦸"}], quiz:{question:"What do they need?", options:["A Bomb", "A Cake"], answer:0}},
  { id: 30, title: "Gunpowder", titleCN: "火药", emoji: "⚫", scenes: [{text:"To make the bomb.", translation:"为了做炸弹。", imageParams:"bg-gray-500", character:"🛠️"}, {text:"We need lots of gunpowder.", translation:"我们需要很多火药。", imageParams:"bg-gray-800", character:"⚫"}, {text:"Go to the Creeper cave.", translation:"去苦力怕洞穴。", imageParams:"bg-green-900", character:"🕳️"}, {text:"Creepers hissed loudly.", translation:"苦力怕大声嘶嘶叫。", imageParams:"bg-green-500", character:"🐍"}, {text:"Mikey lured them into water.", translation:"Mikey把它们引到水里。", imageParams:"bg-blue-500", character:"🌊"}, {text:"They cannot hurt blocks in water.", translation:"在水里它们炸不坏方块。", imageParams:"bg-blue-300", character:"🛡️"}], vocab:[{word:"Make", cn:"做", emoji:"🔨"}, {word:"Lot", cn:"很多", emoji:"🔢"}, {word:"Cave", cn:"洞", emoji:"🕳️"}, {word:"Water", cn:"水", emoji:"💧"}], quiz:{question:"Does water stop damage?", options:["Yes", "No"], answer:0}},
  { id: 31, title: "Super TNT", titleCN: "超级TNT", emoji: "💣", scenes: [{text:"They mixed the ingredients.", translation:"他们混合了材料。", imageParams:"bg-purple-400", character:"🥣"}, {text:"Added some redstone dust.", translation:"加了一些红石粉。", imageParams:"bg-red-500", character:"✨"}, {text:"The bomb looked purple.", translation:"炸弹看起来是紫色的。", imageParams:"bg-purple-700", character:"🟣"}, {text:"It is very unstable.", translation:"它很不稳定。", imageParams:"bg-yellow-400", character:"⚠️"}, {text:"Handle with care!", translation:"小心轻放！", imageParams:"bg-orange-500", character:"🤲"}, {text:"Now let's find the monster.", translation:"现在去找怪物吧。", imageParams:"bg-blue-600", character:"🔎"}], vocab:[{word:"Mix", cn:"混合", emoji:"🔄"}, {word:"Dust", cn:"粉末", emoji:"🌫️"}, {word:"Look", cn:"看/看起来", emoji:"👀"}, {word:"Care", cn:"小心", emoji:"❤️"}], quiz:{question:"Is the bomb stable?", options:["No", "Yes"], answer:0}},
  { id: 32, title: "Minecart Chase", titleCN: "矿车追逐", emoji: "🎢", scenes: [{text:"The monster chased them.", translation:"怪物在追他们。", imageParams:"bg-black", character:"👾"}, {text:"Jump in the minecarts!", translation:"跳进矿车！", imageParams:"bg-gray-400", character:"🛒"}, {text:"They rode on rails.", translation:"他们在铁轨上飞驰。", imageParams:"bg-brown-600", character:"🛤️"}, {text:"Go faster!", translation:"快点！", imageParams:"bg-red-500", character:"⏩"}, {text:"The track is broken ahead.", translation:"前面的路断了。", imageParams:"bg-red-700", character:"💔"}, {text:"Jump over the gap!", translation:"跳过缺口！", imageParams:"bg-blue-400", character:"🆙"}], vocab:[{word:"Chase", cn:"追", emoji:"🏃‍♂️"}, {word:"Jump", cn:"跳", emoji:"🦘"}, {word:"Rail", cn:"铁轨", emoji:"🛤️"}, {word:"Fast", cn:"快", emoji:"⚡"}], quiz:{question:"What did they ride?", options:["Minecart", "Pig"], answer:0}},
  { id: 33, title: "Enderman Ally", titleCN: "末影盟友", emoji: "👁️", scenes: [{text:"They were cornered.", translation:"他们被包围了。", imageParams:"bg-gray-900", character:"😰"}, {text:"The Wither Storm roared.", translation:"凋零风暴咆哮着。", imageParams:"bg-purple-900", character:"🗣️"}, {text:"Suddenly, Endermen appeared.", translation:"突然，末影人出现了。", imageParams:"bg-black", character:"👀"}, {text:"They hate the Storm too.", translation:"他们也讨厌风暴。", imageParams:"bg-purple-600", character:"😠"}, {text:"They pulled blocks from it.", translation:"他们从风暴上拆方块。", imageParams:"bg-green-500", character:"🧱"}, {text:"The monster was distracted.", translation:"怪物分心了。", imageParams:"bg-yellow-200", character:"😵"}], vocab:[{word:"Corner", cn:"角落", emoji:"📐"}, {word:"Appear", cn:"出现", emoji:"👻"}, {word:"Hate", cn:"讨厌", emoji:"😡"}, {word:"Pull", cn:"拉", emoji:"✊"}], quiz:{question:"Who helped them?", options:["Endermen", "Zombies"], answer:0}},
  { id: 34, title: "The Plan", titleCN: "计划", emoji: "📝", scenes: [{text:"We need a plan.", translation:"我们需要一个计划。", imageParams:"bg-blue-900", character:"🤔"}, {text:"JJ will carry the bomb.", translation:"JJ带着炸弹。", imageParams:"bg-green-600", character:"💣"}, {text:"Mikey will shoot arrows.", translation:"Mikey射箭。", imageParams:"bg-brown-500", character:"🏹"}, {text:"We must go inside it.", translation:"我们必须进去。", imageParams:"bg-purple-800", character:"📥"}, {text:"It is dangerous.", translation:"这很危险。", imageParams:"bg-red-600", character:"⚠️"}, {text:"But we are brave.", translation:"但我们很勇敢。", imageParams:"bg-yellow-400", character:"🦁"}], vocab:[{word:"Plan", cn:"计划", emoji:"📅"}, {word:"Carry", cn:"拿/带", emoji:"🎒"}, {word:"Shoot", cn:"射击", emoji:"🎯"}, {word:"Brave", cn:"勇敢", emoji:"💪"}], quiz:{question:"Who carries the bomb?", options:["JJ", "Mikey"], answer:0}},
  { id: 35, title: "Enchanted Sword", titleCN: "附魔剑", emoji: "🗡️", scenes: [{text:"Regular swords break.", translation:"普通的剑会断。", imageParams:"bg-gray-400", character:"🗡️💔"}, {text:"We need a diamond sword.", translation:"我们需要钻石剑。", imageParams:"bg-cyan-400", character:"💎🗡️"}, {text:"Use the enchanting table.", translation:"用附魔台。", imageParams:"bg-red-800", character:"📖"}, {text:"Add Lapis Lazuli.", translation:"加青金石。", imageParams:"bg-blue-600", character:"🔵"}, {text:"Sharpness V!", translation:"锋利 V！", imageParams:"bg-purple-400", character:"🔪"}, {text:"Now it glows purple.", translation:"现在它发紫光了。", imageParams:"bg-purple-600", character:"✨"}], vocab:[{word:"Break", cn:"断/破", emoji:"💥"}, {word:"Need", cn:"需要", emoji:"🤲"}, {word:"Table", cn:"桌子", emoji:"🪑"}, {word:"Glow", cn:"发光", emoji:"🌟"}], quiz:{question:"What sword is it?", options:["Diamond", "Wood"], answer:0}},
  
  // ... (36-40) ...
  { id: 36, title: "Armor Up", titleCN: "穿装备", emoji: "🛡️", scenes: [{text:"Put on your armor.", translation:"穿上你的盔甲。", imageParams:"bg-gray-600", character:"👕"}, {text:"JJ chose Netherite.", translation:"JJ选了下界合金。", imageParams:"bg-black", character:"🛡️"}, {text:"It is very strong.", translation:"它非常结实。", imageParams:"bg-gray-800", character:"💪"}, {text:"Mikey chose Diamond.", translation:"Mikey选了钻石。", imageParams:"bg-cyan-500", character:"💎"}, {text:"Don't forget food.", translation:"别忘了食物。", imageParams:"bg-orange-300", character:"🍗"}, {text:"Eat golden apples.", translation:"吃金苹果。", imageParams:"bg-yellow-400", character:"🍎"}], vocab:[{word:"Put", cn:"放/穿", emoji:"✋"}, {word:"Strong", cn:"强壮", emoji:"🏋️"}, {word:"Choose", cn:"选择", emoji:"👈"}, {word:"Forget", cn:"忘记", emoji:"❓"}], quiz:{question:"What did they eat?", options:["Golden Apples", "Dirt"], answer:0}},
  { id: 37, title: "The Approach", titleCN: "接近", emoji: "🚶", scenes: [{text:"They walked to the storm.", translation:"他们走向风暴。", imageParams:"bg-purple-900", character:"🚶‍♂️"}, {text:"The sky turned black.", translation:"天变黑了。", imageParams:"bg-black", character:"🌑"}, {text:"Lightning struck the ground.", translation:"闪电击中地面。", imageParams:"bg-yellow-300", character:"⚡"}, {text:"Blocks were floating.", translation:"方块在漂浮。", imageParams:"bg-gray-600", character:"🧱"}, {text:"Do not look back.", translation:"别回头。", imageParams:"bg-red-500", character:"👀🚫"}, {text:"We are almost there.", translation:"我们快到了。", imageParams:"bg-green-600", character:"📍"}], vocab:[{word:"Walk", cn:"走", emoji:"🚶"}, {word:"Turn", cn:"变", emoji:"🔄"}, {word:"Strike", cn:"击中", emoji:"🔨"}, {word:"Float", cn:"漂浮", emoji:"🎈"}], quiz:{question:"What color is the sky?", options:["Black", "Blue"], answer:0}},
  { id: 38, title: "Tentacles", titleCN: "触手", emoji: "🦑", scenes: [{text:"The monster has tentacles.", translation:"怪物有触手。", imageParams:"bg-purple-800", character:"🦑"}, {text:"They tried to grab Mikey.", translation:"它们想抓Mikey。", imageParams:"bg-black", character:"✊"}, {text:"JJ cut one off.", translation:"JJ砍掉了一根。", imageParams:"bg-cyan-500", character:"✂️"}, {text:"Watch out above!", translation:"小心上面！", imageParams:"bg-red-500", character:"☝️"}, {text:"A tractor beam!", translation:"引力光束！", imageParams:"bg-purple-400", character:"🔦"}, {text:"Hold onto the ground.", translation:"抓住地面。", imageParams:"bg-brown-600", character:"🧗"}], vocab:[{word:"Grab", cn:"抓", emoji:"✊"}, {word:"Cut", cn:"砍/切", emoji:"🔪"}, {word:"Above", cn:"上面", emoji:"⬆️"}, {word:"Hold", cn:"抓住", emoji:"🤝"}], quiz:{question:"What did JJ cut?", options:["Tentacle", "Tree"], answer:0}},
  { id: 39, title: "Flying Up", titleCN: "飞上去", emoji: "🚀", scenes: [{text:"We cannot walk there.", translation:"我们走不过去。", imageParams:"bg-stone-700", character:"🚶🚫"}, {text:"It is too high.", translation:"太高了。", imageParams:"bg-blue-300", character:"🦒"}, {text:"Use the Elytra wings.", translation:"用鞘翅。", imageParams:"bg-gray-400", character:"🦋"}, {text:"Use fireworks to boost.", translation:"用烟花加速。", imageParams:"bg-red-400", character:"🚀"}, {text:"They flew into the sky.", translation:"他们飞上了天。", imageParams:"bg-blue-600", character:"✈️"}, {text:"Dodging the lasers.", translation:"躲避激光。", imageParams:"bg-purple-500", character:"⚡"}], vocab:[{word:"High", cn:"高", emoji:"📏"}, {word:"Use", cn:"用", emoji:"🔧"}, {word:"Fly", cn:"飞", emoji:"🕊️"}, {word:"Sky", cn:"天", emoji:"☁️"}], quiz:{question:"What did they use to fly?", options:["Elytra", "Boat"], answer:0}},
  { id: 40, title: "The Opening", titleCN: "入口", emoji: "🚪", scenes: [{text:"They saw a mouth.", translation:"他们看到一张嘴。", imageParams:"bg-black", character:"👄"}, {text:"It was open.", translation:"它是张开的。", imageParams:"bg-red-900", character:"⭕"}, {text:"This is our way in.", translation:"这是我们的入口。", imageParams:"bg-green-500", character:"✅"}, {text:"Be careful.", translation:"小心。", imageParams:"bg-yellow-500", character:"⚠️"}, {text:"It smells bad.", translation:"闻起来很臭。", imageParams:"bg-green-800", character:"🤢"}, {text:"Dive in now!", translation:"现在冲进去！", imageParams:"bg-blue-700", character:"🏊"}], vocab:[{word:"Mouth", cn:"嘴", emoji:"👄"}, {word:"Open", cn:"开", emoji:"🔓"}, {word:"Way", cn:"路", emoji:"🛣️"}, {word:"Bad", cn:"坏/臭", emoji:"👎"}], quiz:{question:"Where did they enter?", options:["Mouth", "Ear"], answer:0}},

  // Arc 5: Finale (41-50)
  { id: 41, title: "Dark Maze", titleCN: "黑暗迷宫", emoji: "🕸️", scenes: [{text:"Inside, it was a maze.", translation:"里面是个迷宫。", imageParams:"bg-purple-900", character:"🧩"}, {text:"Walls were made of obsidian.", translation:"墙是用黑曜石做的。", imageParams:"bg-black", character:"⬛"}, {text:"Which way to go?", translation:"走哪边？", imageParams:"bg-gray-600", character:"❓"}, {text:"Mikey placed torches.", translation:"Mikey放了火把。", imageParams:"bg-orange-400", character:"🕯️"}, {text:"Follow the light.", translation:"跟着光走。", imageParams:"bg-yellow-200", character:"💡"}, {text:"They found a door.", translation:"他们找到了一扇门。", imageParams:"bg-brown-500", character:"🚪"}], vocab:[{word:"Inside", cn:"里面", emoji:"🏠"}, {word:"Wall", cn:"墙", emoji:"🧱"}, {word:"Way", cn:"路/方向", emoji:"⬅️"}, {word:"Light", cn:"光", emoji:"🔦"}], quiz:{question:"What did Mikey place?", options:["Torches", "Water"], answer:0}},
  { id: 42, title: "Infected Mobs", titleCN: "被感染的怪物", emoji: "🧟", scenes: [{text:"Purple zombies attacked.", translation:"紫色僵尸发起了攻击。", imageParams:"bg-purple-700", character:"🧟"}, {text:"They are infected.", translation:"他们被感染了。", imageParams:"bg-green-900", character:"🦠"}, {text:"They are stronger now.", translation:"他们现在更强了。", imageParams:"bg-red-600", character:"💪"}, {text:"Push them back.", translation:"把他们推回去。", imageParams:"bg-blue-500", character:"✋"}, {text:"Do not let them touch you.", translation:"别让他们碰到你。", imageParams:"bg-yellow-400", character:"🚫"}, {text:"Run to the next room.", translation:"跑到下一个房间。", imageParams:"bg-gray-500", character:"🏃"}], vocab:[{word:"Purple", cn:"紫色", emoji:"🟣"}, {word:"Strong", cn:"强壮", emoji:"🏋️"}, {word:"Push", cn:"推", emoji:"🫷"}, {word:"Touch", cn:"碰", emoji:"👆"}], quiz:{question:"What color were the zombies?", options:["Purple", "Green"], answer:0}},
  { id: 43, title: "Parkour", titleCN: "跑酷", emoji: "🤸", scenes: [{text:"The floor is gone.", translation:"地板没了。", imageParams:"bg-black", character:"🕳️"}, {text:"We have to jump.", translation:"我们必须跳。", imageParams:"bg-blue-300", character:"🆙"}, {text:"Jump on the floating blocks.", translation:"跳在浮空方块上。", imageParams:"bg-purple-500", character:"⬜"}, {text:"Don't look down.", translation:"别往下看。", imageParams:"bg-red-400", character:"🫣"}, {text:"Mikey almost fell.", translation:"Mikey差点掉了下去。", imageParams:"bg-yellow-300", character:"😱"}, {text:"JJ caught his hand.", translation:"JJ抓住了他的手。", imageParams:"bg-green-500", character:"🤝"}], vocab:[{word:"Gone", cn:"没了", emoji:"💨"}, {word:"Jump", cn:"跳", emoji:"🦘"}, {word:"Look", cn:"看", emoji:"👀"}, {word:"Hand", cn:"手", emoji:"✋"}], quiz:{question:"Did Mikey fall?", options:["Almost", "Yes"], answer:0}},
  { id: 44, title: "Command Block", titleCN: "命令方块", emoji: "🟧", scenes: [{text:"They reached the center.", translation:"他们到了中心。", imageParams:"bg-purple-900", character:"🎯"}, {text:"There it is.", translation:"它在那。", imageParams:"bg-black", character:"point"}, {text:"The Command Block.", translation:"命令方块。", imageParams:"bg-orange-500", character:"🟧"}, {text:"It was glowing brightly.", translation:"它闪闪发光。", imageParams:"bg-yellow-200", character:"✨"}, {text:"It controls the storm.", translation:"它控制着风暴。", imageParams:"bg-blue-500", character:"🎮"}, {text:"We must break it.", translation:"我们必须打破它。", imageParams:"bg-red-600", character:"🔨"}], vocab:[{word:"Center", cn:"中心", emoji:"⭕"}, {word:"Block", cn:"方块", emoji:"🧊"}, {word:"Bright", cn:"明亮", emoji:"🔆"}, {word:"Break", cn:"打破", emoji:"💥"}], quiz:{question:"What controls the storm?", options:["Command Block", "Lever"], answer:0}},
  { id: 45, title: "The Shield", titleCN: "护盾", emoji: "🛡️", scenes: [{text:"They tried to hit it.", translation:"他们试着打它。", imageParams:"bg-gray-500", character:"👊"}, {text:"But it has a shield.", translation:"但它有个护盾。", imageParams:"bg-blue-400", character:"🛡️"}, {text:"Arrows bounced off.", translation:"箭被弹开了。", imageParams:"bg-yellow-300", character:"↩️"}, {text:"We need the Formidibomb.", translation:"我们需要恐怖炸弹。", imageParams:"bg-purple-600", character:"💣"}, {text:"Plant it on the shield.", translation:"把它安在护盾上。", imageParams:"bg-green-500", character:"🌱"}, {text:"Get ready to run.", translation:"准备跑。", imageParams:"bg-orange-400", character:"👟"}], vocab:[{word:"Try", cn:"尝试", emoji:"💪"}, {word:"Shield", cn:"护盾", emoji:"🛡️"}, {word:"Need", cn:"需要", emoji:"🤲"}, {word:"Run", cn:"跑", emoji:"🏃"}], quiz:{question:"Did arrows work?", options:["No", "Yes"], answer:0}},
  { id: 46, title: "Ignite", titleCN: "点火", emoji: "🔥", scenes: [{text:"JJ placed the bomb.", translation:"JJ放好了炸弹。", imageParams:"bg-purple-800", character:"💣"}, {text:"Mikey lit the fuse.", translation:"Mikey点了引线。", imageParams:"bg-orange-500", character:"🔥"}, {text:"Fsssss... It is burning.", translation:"嘶嘶……它在烧。", imageParams:"bg-yellow-200", character:"🔊"}, {text:"Run away fast!", translation:"快跑开！", imageParams:"bg-blue-600", character:"⏩"}, {text:"They hid behind a wall.", translation:"他们躲在墙后面。", imageParams:"bg-gray-700", character:"🧱"}, {text:"Cover your ears.", translation:"捂住耳朵。", imageParams:"bg-green-400", character:"🙉"}], vocab:[{word:"Place", cn:"放置", emoji:"📍"}, {word:"Burn", cn:"烧", emoji:"🔥"}, {word:"Fast", cn:"快", emoji:"⚡"}, {word:"Ear", cn:"耳朵", emoji:"👂"}], quiz:{question:"What did they hide behind?", options:["Wall", "Tree"], answer:0}},
  { id: 47, title: "Explosion", titleCN: "爆炸", emoji: "💥", scenes: [{text:"3... 2... 1...", translation:"3……2……1……", imageParams:"bg-black", character:"⏱️"}, {text:"BOOM!", translation:"轰！", imageParams:"bg-white", character:"💥"}, {text:"A huge explosion happened.", translation:"发生了巨大的爆炸。", imageParams:"bg-orange-500", character:"🌋"}, {text:"The purple shield broke.", translation:"紫色护盾碎了。", imageParams:"bg-purple-300", character:"💔"}, {text:"The Command Block is open.", translation:"命令方块露出来了。", imageParams:"bg-orange-600", character:"🔓"}, {text:"Now is our chance!", translation:"机会来了！", imageParams:"bg-green-500", character:"✨"}], vocab:[{word:"Huge", cn:"巨大", emoji:"🐘"}, {word:"Happen", cn:"发生", emoji:"❗"}, {word:"Break", cn:"碎/破", emoji:"🔨"}, {word:"Chance", cn:"机会", emoji:"🍀"}], quiz:{question:"Is the shield broken?", options:["Yes", "No"], answer:0}},
  { id: 48, title: "Final Strike", titleCN: "最后一击", emoji: "🗡️", scenes: [ { text: "JJ took out his sword.", translation: "JJ拿出了他的剑。", imageParams:"bg-blue-600", character: "🗡️" }, { text: "It was the Enchanted Sword.", translation: "那是附魔剑。", imageParams:"bg-purple-400", character: "✨" }, { text: "He jumped high.", translation: "他跳得很高。", imageParams:"bg-yellow-200", character: "🆙" }, { text: "For Minecraft!", translation: "为了Minecraft！", imageParams:"bg-green-600", character: "🌍" }, { text: "He hit the Command Block.", translation: "他击中了命令方块。", imageParams:"bg-orange-500", character: "💥" }, { text: "Crack! It shattered.", translation: "咔嚓！它碎了。", imageParams:"bg-white", character: "🧩" } ], vocab: [ { word: "Sword", cn: "剑", emoji: "🗡️" }, { word: "High", cn: "高", emoji: "📏" }, { word: "Hit", cn: "击中", emoji: "🎯" }, { word: "Shatter", cn: "粉碎", emoji: "🔨" } ], quiz: { question: "What did JJ hit?", options: ["Command Block", "Mikey"], answer: 0 } },
  { id: 49, title: "Storm Clears", titleCN: "风暴消散", emoji: "🌤️", scenes: [ { text: "The monster screamed.", translation: "怪物尖叫着。", imageParams:"bg-purple-900", character: "😱" }, { text: "It turned into smoke.", translation: "它变成了烟雾。", imageParams:"bg-gray-500", character: "🌫️" }, { text: "The sky cleared up.", translation: "天空放晴了。", imageParams:"bg-blue-300", character: "☁️" }, { text: "The sun shined down.", translation: "太阳照下来了。", imageParams:"bg-yellow-300", character: "☀️" }, { text: "The world was green again.", translation: "世界又变绿了。", imageParams:"bg-green-500", character: "🌳" }, { text: "They fell to the ground.", translation: "他们落到了地上。", imageParams:"bg-brown-400", character:"⬇️" } ], vocab: [ { word: "Scream", cn: "尖叫", emoji: "🗣️" }, { word: "Smoke", cn: "烟", emoji: "🚬" }, { word: "Clear", cn: "晴朗/清晰", emoji: "🧹" }, { word: "Green", cn: "绿色", emoji: "🟩" } ], quiz: { question: "Is the monster gone?", options: ["Yes", "No"], answer: 0 } },
  { id: 50, title: "Ultimate Victory", titleCN: "终极胜利", emoji: "👑", scenes: [ { text: "JJ and Mikey woke up.", translation: "JJ和Mikey醒了。", imageParams:"bg-green-200", character: "🥱" }, { text: "Everyone was cheering.", translation: "大家都在欢呼。", imageParams:"bg-yellow-200", character: "🎉" }, { text: "You saved us!", translation: "你们救了我们！", imageParams:"bg-blue-200", character: "🙏" }, { text: "They are true heroes.", translation: "他们是真正的英雄。", imageParams:"bg-gold-400", character: "🦸" }, { text: "Let's build a new world.", translation: "我们要建一个新世界。", imageParams:"bg-brown-300", character: "🏗️" }, { text: "The adventure continues!", translation: "冒险继续！", imageParams:"bg-orange-400", character: "🚀" } ], vocab: [ { word: "Wake", cn: "醒", emoji: "⏰" }, { word: "Save", cn: "救", emoji: "🚑" }, { word: "Hero", cn: "英雄", emoji: "👑" }, { word: "Build", cn: "建造", emoji: "🧱" } ], quiz: { question: "Are they heroes?", options: ["Yes", "No"], answer: 0 } }
];
